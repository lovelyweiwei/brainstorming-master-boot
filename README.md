...
![项目结构图](./images/README-1694251310847.png)

## 项目核心业务流程 🔥

判题服务：获取题目信息、预计的输入输出结果，返回给主业务后端：用户的答案是否正确
代码沙箱：只负责运行代码，给出程序运行的结果，不用管用户提交的程序是否正确。 因此 判题服务 和 代码沙箱 实现了解耦
![OJ-business-Map](./images/README-1694246948088.png)
核心流程时序图
![时序图](./images/README-1694247006735.png)
...
![创建题目](./images/创建题目1.png)
![创建题目](./images/创建题目2.png)

### 题目管理

![题目管理](./images/管理题目.png)

### 修改题目信息

![修改题目信息](./images/更新题目1.png)

![修改题目信息](./images/更新题目2.png)

![修改题目信息](./images/更新题目3.png)

### 做题页面展示

![做题页面展示](./images/做题.png)
